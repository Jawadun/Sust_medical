...
"C:\\Users\\HP\\AppData\\Local\\Android\\sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=F:\\Code Flutter\\sust_medical\\android\\app\\build\\intermediates\\cxx\\Debug\\442d2l68\\obj\\armeabi-v7a" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=F:\\Code Flutter\\sust_medical\\android\\app\\build\\intermediates\\cxx\\Debug\\442d2l68\\obj\\armeabi-v7a" ^
  "-DCMAKE_BUILD_TYPE=Debug" ^
  "-BF:\\Code Flutter\\sust_medical\\android\\app\\.cxx\\Debug\\442d2l68\\armeabi-v7a" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli

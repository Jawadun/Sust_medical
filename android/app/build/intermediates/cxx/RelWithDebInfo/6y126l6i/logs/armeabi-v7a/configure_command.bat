...
"C:\\Users\\HP\\AppData\\Local\\Android\\sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=F:\\Code Flutter\\sust_medical\\android\\app\\build\\intermediates\\cxx\\RelWithDebInfo\\6y126l6i\\obj\\armeabi-v7a" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=F:\\Code Flutter\\sust_medical\\android\\app\\build\\intermediates\\cxx\\RelWithDebInfo\\6y126l6i\\obj\\armeabi-v7a" ^
  "-DCMAKE_BUILD_TYPE=RelWithDebInfo" ^
  "-BF:\\Code Flutter\\sust_medical\\android\\app\\.cxx\\RelWithDebInfo\\6y126l6i\\armeabi-v7a" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli

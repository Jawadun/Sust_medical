...
"C:\\Users\\HP\\AppData\\Local\\Android\\sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=F:\\Code Flutter\\sust_medical\\android\\app\\build\\intermediates\\cxx\\RelWithDebInfo\\6y126l6i\\obj\\x86" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=F:\\Code Flutter\\sust_medical\\android\\app\\build\\intermediates\\cxx\\RelWithDebInfo\\6y126l6i\\obj\\x86" ^
  "-DCMAKE_BUILD_TYPE=RelWithDebInfo" ^
  "-BF:\\Code Flutter\\sust_medical\\android\\app\\.cxx\\RelWithDebInfo\\6y126l6i\\x86" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli
